...
Although Bundler manages an own <tt>Gemfile.lock</tt> for each wagon, it is NOT recommended to check these
into source control. The <tt>Gemfile.lock</tt> of the application should be the single responsible for 
gem versions.
